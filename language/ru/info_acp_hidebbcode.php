...
$lang = array_merge($lang, array(
	...
	'HIDEBB_HIDE_ATTACH_EXPLAIN'	=>	'Скрывать вложения в сообщении, если в нём присутствует [hide] BBCode. Вложения, вставленные в текст сообщения, будут скрыты, если они находятся внутри тегов [hide], иначе они будут отображаться. Прочие вложения будут скрыты, если [hide] BBCode присутствует в тексте сообщения.',
));
